...
After logging into your Jenkins instance there should be already one job ready to trigger, called "SetupDSLJobs". Build SetupDSLJobs with parameters, put your project name, GitHub url, and it will generate three base pipelines and one view that contains all of them in one place.
